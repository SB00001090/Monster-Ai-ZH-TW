...
import { LayoutDashboard, LogOut, PanelLeft, Users, MessageCircle, Settings, BookOpen, Cpu, Bot, MessageSquare, Cog, Music, Film } from "lucide-react";
...
const menuItems = [
  { icon: LayoutDashboard, label: "navigation.home", path: "/" },
  { icon: MessageCircle, label: "navigation.chatWithCharacter", path: "/character-chat" },
